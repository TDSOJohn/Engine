...
int main()
{
    ...
    auto button_1 = std::make_shared<eng::Button>(fonts, eng::Fonts::IBMPlexMono_Regular, text, eng::Textures::Buttons);
    ...
    //  Create a button, set its position, text and callback function
    auto button_2 = std::make_shared<eng::Button>(fonts, eng::Fonts::IBMPlexMono_Regular, text, eng::Textures::Buttons);
    ...
    auto input_1 = std::make_shared<eng::InputField>(fonts, eng::Fonts::IBMPlexMono_Regular, text, eng::Textures::InputField, "Insert text");
